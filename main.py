...
def main(set, args):
    ...
    if args.dataset == "DFEW":
        ...
        log_txt_path = './log/' + 'DFEW-' + time_str + '-set' + str(
            data_set) + '-log-' + args.detail + '/' + 'log-' + args.detail + '.txt'
        log_curve_path = './log/' + 'DFEW-' + time_str + '-set' + str(
            data_set) + '-log-' + args.detail + '/' + 'log.png'
        log_confusion_matrix_path = './log/' + 'DFEW-' + time_str + '-set' + str(
            data_set) + '-log-' + args.detail + '/' + 'cn.png'
        checkpoint_path = './log/' + 'DFEW-' + time_str + '-set' + str(
            data_set) + '-log-' + args.detail + '/' + 'checkpoint/' + 'model.pth'
        ...
        # 创建包含 args.detail 的文件夹路径
        base_log_path = './log/' + 'DFEW-' + time_str + '-set' + str(data_set) + '-log-' + args.detail + '/'
        os.makedirs(base_log_path, exist_ok=True)
        os.makedirs(base_log_path + 'checkpoint/', exist_ok=True)
        os.makedirs(base_log_path + 'code/', exist_ok=True)
        os.makedirs(base_log_path + 'code/models', exist_ok=True)
        os.makedirs(base_log_path + 'code/AudioMAE', exist_ok=True)
        os.makedirs(base_log_path + 'code/dataloader', exist_ok=True)

        for filename in ['main.py', 'train_DFEW.sh', 'train_MAFW.sh', 'models/Generate_Model.py',
                         'models/Temporal_Model.py', 'dataloader/video_dataloader.py', 'dataloader/video_transform.py',
                         'models/models_vit.py', 'AudioMAE/audio_models_vit.py', 'testblock.py', 'models/adapter.py']:
            shutil.copyfile(filename, base_log_path + 'code/' + filename)

    elif args.dataset == "MAFW":
        print("*********** MAFW Dataset Fold  " + str(data_set) + " ***********")
        log_txt_path = './log/' + 'MAFW-' + time_str + '-set' + str(
            data_set) + '-log-' + args.detail + '/' + 'log-' + args.detail + '.txt'
        log_curve_path = './log/' + 'MAFW-' + time_str + '-set' + str(
            data_set) + '-log-' + args.detail + '/' + 'log.png'
        log_confusion_matrix_path = './log/' + 'MAFW-' + time_str + '-set' + str(
            data_set) + '-log-' + args.detail + '/' + 'cn.png'
        checkpoint_path = './log/' + 'MAFW-' + time_str + '-set' + str(
            data_set) + '-log-' + args.detail + '/' + 'checkpoint/' + 'model.pth'
        ...
        # 创建包含 args.detail 的文件夹路径
        base_log_path = './log/' + 'MAFW-' + time_str + '-set' + str(data_set) + '-log-' + args.detail + '/'
        os.makedirs(base_log_path, exist_ok=True)
        os.makedirs(base_log_path + 'checkpoint/', exist_ok=True)
        os.makedirs(base_log_path + 'code/', exist_ok=True)
        os.makedirs(base_log_path + 'code/models', exist_ok=True)
    ...
    # optimizer = torch.optim.AdamW( params=[param for param in model.parameters() if param.requires_grad], lr=args.lr, weight_decay=args.weight_decay)
    ...
    last_uar, last_war = computer_uar_war(val_loader, model, checkpoint_path, log_confusion_matrix_path, log_txt_path,
                                          data_set, args.class_names)
...
def computer_uar_war(val_loader, model, checkpoint_path, log_confusion_matrix_path, log_txt_path, data_set,
                     class_names):
