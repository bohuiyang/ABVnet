...
root_dir = '/home/mnt_disk2/MAFW/clips/'
write_dir = '/home/mnt_disk2/MAFW/clips_faces/'
    ...
    for filename in os.listdir(root_dir):
        ...
        while True:
            ...
            if bbox[0] is not None:
                ...
                im = im[im.shape[0] // 2 - ss // 2:im.shape[0] // 2 + ss // 2,
                     im.shape[1] // 2 - ss // 2:im.shape[1] // 2 + ss // 2, :]
                cv2.imwrite(os.path.join(write_dir, filename.split('.')[0], str(frame_count) + '.jpg'), im)
                frame_count += 1
